...
<form method="POST" action="{{route('update.album', $albumData->id)}}" enctype="multipart/form-data">
    @csrf
    <div class="row">
        <div class="col-lg-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row mb-3">
                        ...
                        <input name="album_title" class="form-control -mb-2 @error('album_title') is-invalid @enderror" type="text" value="{{$albumData->album_title}}" placeholder="Sunset Nature"
                            id="album-title">
                            @error('"album_title')
                    ...
                    <div class="row mb-3">
                        ...
                        <input name="album_subtext" class="form-control @error('album_subtext') is-invalid @enderror" type="text" value="{{$albumData->album_subtext}}" placeholder="Nature Photos"
                            id="album-subtext">
                            @error('album-subtext')
                            <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="row mb-3">
                        ...
                        <input name="publish" class="form-control @error('publish') is-invalid @enderror" type="date" value="{{$albumData->publish}}" id="publish">
                    </div>
                    <label for="publish" class="col-form-label @error('name') is-invalid @enderror">Gallery Description</label>
                    <textarea name='gallery_message' required="" class="form-control" rows="5">{{$albumData->gallery_message}}</textarea>
