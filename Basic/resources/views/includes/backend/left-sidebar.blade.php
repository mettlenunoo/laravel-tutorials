<div class="vertical-menu">
    ...
    <div data-simplebar class="h-100">
        ...
        <div id="sidebar-menu">
            <!-- Left Menu Start -->
            @if (Auth::user()->role == env('SUPERADMIN'))
                <ul class="metismenu list-unstyled" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="sub-menu" aria-expanded="false">
                            <li><a href="{{ route('about.info') }}">About Information</a></li>
                            <li><a href="{{ route('about.multi.image') }}">About Multiple Images</a></li>
                            <li><a href="{{ route('all.about.multi.image') }}">All About Multiple Images</a></li>
                        </ul>
                    </li>
