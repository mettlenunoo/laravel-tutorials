    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <p class="card-title-desc">Change your Password here</p>

                <form method="post" action="{{route('update.password')}}">
                    @csrf
                    <div class="row mb-3">
                        <label for="current-password" class="col-sm-2 col-form-label">Old Password</label>
                        <div class="col-sm-10">
                            <input name="old_password" class="form-control @error('old_password') is-invalid @enderror" type="password" value="" id="old-password">
